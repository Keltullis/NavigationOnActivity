...
import com.bignerdranch.android.navonactivity.databinding.FragmentAboutBinding
...
class AboutFragment : Fragment(), HasCustomTitle {
    ...
    //если этому фрагменту нужен собственный заголовой тулбара,то он реализует интерфейс HasCustomTitle
